...
<body>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Group savings</h4>
                <div class="table-responsive">
                  <div id="add_user">
                    <p class="badge badge-pill gradient-1" id="add_saving"><i class="btn btn-sm fa fa-plus fa-2x p-2" id="" data-toggle="tooltip" data-placement="top" title="Add a saving"></i></p>
                    <p class="badge badge-pill gradient-1" id="add_withdraw"><i class="btn btn-sm fa fa-minus fa-2x p-2" id="" data-toggle="tooltip" data-placement="top" title="Add a withdraw"></i></p>
                  </div>
                  <?php
  ...
  <script src="../js/custom_js/savings.js"></script>
