                  ...
                  <div class="form-validation">
                    <form class="form-valide" action="#" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            type="text"
                            class="form-control"
                            id="val-employeeNumber"
                            name="val-employeeNumber"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            ...
                            id="val-telephone"
                            name="val-telephone"
                            placeholder="Enter the user's telephone"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            ...
                            placeholder="Enter user's nationality here"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <select
                            type="text"
                            class="form-control"
                            id="val-identity-type"
                            name="val-identity-type"
                          >
                      ...
                      <div class="form-group row">
                        <label
                          class="col-lg-4 col-form-label text-right"
                          for="val-identity-number"
                          >Identity Number <span class="text-danger">*</span>
                        </label>
                        <div class="col-lg-6">
                          <input
                            type="text"
                            class="form-control"
                            id="val-identity-number"
                            name="val-identity-number"
                            placeholder="Enter NIN / passprot number / driver's licence number"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            type="date"
                            class="form-control"
                            id="val-date-of-birth"
                            name="val-date-of-birth"
                            placeholder="5.0"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label
                          class="col-lg-4 col-form-label text-right"
                          for="val-staff-category"
                          >Staff category <span class="text-danger">*</span>
                        </label>
                        <div class="col-lg-6">
                          <input
                            type="text"
                            class="form-control"
                            id="val-staff-category"
                            name="val-staff-category"
