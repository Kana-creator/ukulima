...
<body>
  ...
  <div id="main-wrapper container">
    ...
    <!--**********************************
            Sidebar start
        ***********************************-->
    <div class="nk-sidebar text-light" style="background-color: rgba(0, 255, 127, 0.9);">
      <div class="nk-nav-scroll text-light" style="background-color: rgba(0, 255, 127, 0.9);">
        <ul class="metismenu txt-light" id="menu" style="background-color: rgba(0, 255, 127, 0.9);">
          <li class="nav-label">Dashboard</li>
          <li>
            <a class="has-arrow" href="javascript:void()" aria-expanded="fals" style="background-color: #00FF7F;">
              <i class="icon-speedometer menu-icon"></i><span class="nav-text">Dashboard</span>
            </a>
            <ul aria-expanded="false" class="" style="background-color: rgba(0, 255, 127, 0.9); font-weight: 500; color:black">
              <li><a href="./settings.php"><span><i class="fa fa-home"></i></span> Settings</a></li>
