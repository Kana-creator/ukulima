...
if (isset($_SESSION['user_id'])) {
  ...
  $cart_row2 = $cart_result2->fetch_array();
  $number_of_items = $cart_row2['number_of_items'];
} else {
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <div id="add_product">
                    <a href="#" class="badge badge-pill gradient-3" onclick="tableToCSV()"><i class="fa fa-download fa-2x p-2 btn btn-sm" id="" data-toggle="tooltip" data-placement="top" title="Download orders list"></i></a>
