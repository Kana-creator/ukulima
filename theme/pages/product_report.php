...
if (isset($_SESSION['user_id'])) {
    ...
    $report_result = $mysqli->query("SELECT * FROM product_report");
} else {
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <?php
                                            while ($report_row = $report_result->fetch_array()) :
                                                $user_id = $report_row['user_id'];
                                                $user_result = $mysqli->query("SELECT user_telephone FROM User WHERE user_id = $user_id");
                                                $user_row = $user_result->fetch_assoc();
                                            ?>
                                                <tr>
                                                    <td><?php echo decrypt_data($report_row['report_type']); ?></td>
                                                    <td><?php echo decrypt_data($report_row['serial_number']); ?></td>
                                                    <td><?php echo decrypt_data($report_row['supplier']); ?></td>
                                                    <td><?php echo decrypt_data($report_row['producer']); ?></td>
                                                    <td>
                                                        <?php echo decrypt_data($report_row['report_details']); ?>
                                                    </td>
                                                    <td><?php echo decrypt_data($user_row['user_telephone']); ?></td>
                                                    <td><?php echo $report_row['record_date']; ?></td>
                                                </tr>
