                    ...
                    <form class="form-valide" action="#" method="post">
                      ...
                      <div class="form-group row">
                        <label
                          class="col-lg-4 col-form-label text-right"
                          for="val-supplier"
                          >Registered distributer / supplier<span
                            class="text-danger"
                            >*</span
                          >
                        </label>
                        <div class="col-lg-6">
                          <input
                            ...
                            id="val-supplier"
                            name="val-supplier"
                            placeholder="Enter registered supplier here"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            type="text"
                            class="form-control"
                            id="val-point-of-origin"
                            name="val-point-of-origin"
                            placeholder="Enter product point of origin here."
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            type="date"
                            class="form-control"
                            id="val-date-of-manufacture"
                            name="val-date-of-manufacture"
                            placeholder="Enter product date of manufacture here."
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            type="date"
                            class="form-control"
                            id="val-date-of-expiry"
                            name="val-date-of-expiry"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            ...
                            accept="image/*"
                            class="form-control"
                            id="val-product-image"
                            name="val-product-image"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <input
                            type="text"
                            class="form-control"
                            id="val-unit-of-measure"
                            name="val-unit-of-measure"
                            placeholder="Enter product unit of measure"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <textarea
                            class="form-control"
                            id="val-e-extension"
                            name="val-e-extension"
                            rows="10"
                            placeholder="Enter the product e-extension (How to use the product)"
                          ></textarea>
                        </div>
                      </div>
