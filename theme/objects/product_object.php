...
class Product
{
    ...
    public function set_properties($product_id, $brand_name, $product_manufacturer, $product_supplier, $point_of_origin, $date_of_manufacture, $expiry_date, $product_image, $unit_of_measure, $batch_number, $serial_number, $product_category, $unit_cost, $user_guid)
    {
