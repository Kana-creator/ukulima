...
$(() => {
    ...
    $("#add_saving").on('click', () => {
        ...
        $("#action").val("save_saving");
        $("#form-title").text("Add a member's saving");
        $("#next_of_kin").text("Brought by");

    });

    $("#add_withdraw").on('click', () => {
        $("#user-details").addClass("show");
        $("#action").val("save_withdraw");
        $("#form-title").text("Add a member's withdraw");
        $("#next_of_kin").text("Taken by");
    })
            ...
            $.ajax({
                ...
                success: res => {
                    ...
                    if (res['status'] === "success") {
                        window.location.href = "../pages/savings.php";
                    }
                }
            })
