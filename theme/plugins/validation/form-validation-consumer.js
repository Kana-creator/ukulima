jQuery(".form-valide").validate({
    ...
    rules:
    {
        ...
        "val-member-category": { required: !0 },
        "val-date-of-birth": {required: !0},
        "val-occupation": {required: !0},
        "val-major-economic-activity": {required: !0},
    ...
    messages:
    {
        ...
        "val-member-category": "Please select member category",
        "val-occupation": "Please enter member's occupation.",
        "val-major-economic-activity": "Please enter member's major economic activity.",
